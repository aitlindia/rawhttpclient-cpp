...
{
  char ReqParam[512];
  char *Request = "/NECLDBService/common/saveRfqDataForFRGET?";
				   
  char *Data = "macAddress=00:23:68:DB:0F:54&event=4&rfidTag=1234567890C622266125&rfidReaderId=4&timeStamp=2018-01-24%2018:59:38&containerNo=CAXU6442769&rfidSeqNo=20&WagonNo=RABCG";
  //string ReqData =Request+Data;
  strcpy(ReqParam,Request);
  strcat(ReqParam,Data);
...
void demoSIBPLPost()
{
  ...
  char ReqParam[512];
  char *Request = "/NECLDBService/common/saveRfqDataForFRPOST?";
				   
  char *Data = "macAddress=00:23:68:DB:0F:54&event=4&rfidTag=1234567890C622266125&rfidReaderId=4&timeStamp=2018-01-24%2018:59:38&containerNo=CAXU6442769&rfidSeqNo=20&WagonNo=RABCG";
  //string ReqData =Request+Data;
  strcpy(ReqParam,Request);
  strcat(ReqParam,Data);
  printf("PostReqParam=%s",ReqParam);

 // const char *body = "{\"MacRegObject\": {\"rfidReaderId\": \"4\",\"rfidTag\": \"1234567890C622255125\",\"macAddress\": \"00:23:68:DB:0F:54\",\"event\": \"4\",\"timeStamp\": \"2018-01-24 18:59:38\",\"containerNo\": \"CAXU6442769\",\"rfidSeqNo\": \"20\"}}";
 const char *body = "{}";

  HttpRequest request("192.168.1.69", 80); //aitlhttp.herokuapp.com//sibpl.xtpl.co.in
  request.initCallbacks(headersReady, receiveData, responseComplete, 0);
  request.sendRequest("POST", ReqParam, headers, (const unsigned char*)body, strlen(body));
